...
const BasketContextProvider = ({ children }) => {
  ...
  // this STATE will check which restaurant page we are currently in
  const [restaurant, setRestaurant] = useState(null);

  // this STATE will check if an existing basket already exist
  // or we need to create a new basket
  ...
  const addDishToBasket = async (dish, quantity) => {
    ...
    // creat a BasketDish item and save to DataStore
